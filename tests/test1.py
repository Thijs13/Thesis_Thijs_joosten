...
class Test(unittest.TestCase):
    ...
    def test_position(self):
        ...
        # print(testText)
        pos = pos.succ(moves[4])
        pos = parse_position("..............o...................x...............W")
        move = generate_moves(pos)[0]
        pos = parse_position("..................................x...............W")
        display_position(pos)
        pos.succ(move)
        display_position(pos)
        print(pos.can_move(Side.White))
        display_position(pos)
        for move in moves:
        ...
        pos = parse_position(text)
        display_position(pos)
        # print(display_position(pos))
        # if "white wins #" display_position(pos):
        #     print("win")
        self.assertTrue(pos.can_move(Side.White))
        self.assertTrue(pos.can_move(Side.Black))
        print('eval3', eval_position(pos))
        print("t")
